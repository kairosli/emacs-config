...
(add-to-list 'load-path "~/kairosli/.emacs.d/site-lisp/auto-complete/")
(require 'auto-complete-config)
(add-to-list 'ac-dictionary-directories "~/kairosli/.emacs.d/site-lisp/auto-complete/ac-dict")
(ac-config-default)
...
;; (global-set-key (kbd "C-c a") 'ac-start)
